...
|---|---|---|
| Size (400 entities) | ~510 KB (~48 KB gzipped) | ~710 KB (~155 KB gzipped) |
...
At 400 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 676 edges instead of 4,733.
