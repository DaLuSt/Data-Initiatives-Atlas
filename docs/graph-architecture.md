...
|---|---|---|
| Size (312 entities) | ~387 KB (~37 KB gzipped) | ~533 KB (~124 KB gzipped) |
...
At 312 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 466 edges instead of 3,588.
