...
|---|---|---|
| Size (461 entities) | ~587 KB (~48 KB gzipped) | ~897 KB (~155 KB gzipped) |
...
At 461 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 922 edges instead of 5,379.
