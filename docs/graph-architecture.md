...
|---|---|---|
| Size (341 entities) | ~426 KB (~41 KB gzipped) | ~586 KB (~135 KB gzipped) |
...
At 341 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 522 edges instead of 3,986.
