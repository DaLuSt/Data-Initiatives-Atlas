...
|---|---|---|
| Size (244 entities) | ~274 KB (~28 KB gzipped) | ~392 KB (~94 KB gzipped) |
...
At 244 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 346 edges instead of 2,420.
