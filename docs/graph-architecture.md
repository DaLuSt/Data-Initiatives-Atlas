...
|---|---|---|
| Size (258 entities) | ~295 KB (~30 KB gzipped) | ~419 KB (~100 KB gzipped) |
...
At 258 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 354 edges instead of 2,649.
