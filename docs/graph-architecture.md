...
two entities are mentioned together". The default view shows only the 300
typed relationships; the other 1,723 edges are one checkbox away.
...
|---|---|---|
| Size (220 entities) | ~234 KB (~24 KB gzipped) | ~337 KB (~81 KB gzipped) |
...
At 220 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 300 edges instead of 2,023.
