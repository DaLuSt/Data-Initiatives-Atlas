...
two entities are mentioned together". The default view shows only the 189
typed relationships; the other 1,118 edges are one checkbox away.
...
1. **Typed relationships only by default** — 189 edges instead of 1,307.
