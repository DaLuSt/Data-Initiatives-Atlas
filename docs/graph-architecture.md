...
|---|---|---|
| Size (389 entities) | ~495 KB (~47 KB gzipped) | ~686 KB (~153 KB gzipped) |
...
At 389 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 651 edges instead of 4,608.
