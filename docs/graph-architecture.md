...
|---|---|---|
| Size (361 entities) | ~450 KB (~43 KB gzipped) | ~626 KB (~143 KB gzipped) |
...
At 361 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 555 edges instead of 4,204.
