...
|---|---|---|
| Size (396 entities) | ~503 KB (~48 KB gzipped) | ~697 KB (~155 KB gzipped) |
...
At 396 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 666 edges instead of 4,672.
