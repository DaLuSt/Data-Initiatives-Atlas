...
|---|---|---|
| Size (354 entities) | ~439 KB (~42 KB gzipped) | ~608 KB (~139 KB gzipped) |
...
At 354 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 539 edges instead of 4,089.
