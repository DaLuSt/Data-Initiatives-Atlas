...
|---|---|---|
| Size (340 entities) | ~421 KB (~40 KB gzipped) | ~574 KB (~132 KB gzipped) |
...
At 340 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 498 edges instead of 3,932.
