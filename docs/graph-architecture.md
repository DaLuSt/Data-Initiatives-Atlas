...
|---|---|---|
| Size (516 entities) | ~613 KB (~55 KB gzipped) | ~926 KB (~180 KB gzipped) |
...
At 516 entities this split is not strictly necessary. It is there because
...
1. **Typed relationships only by default** — 1,095 edges instead of 6,170.
