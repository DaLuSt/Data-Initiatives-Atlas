...
up during 2021 and became operational from **January 2022**.
...
## ⚠ `coverage: low`, and no relationships

Only DVS's own site was returned by search. Its legal form, its governance,
its relationship to [[CH-EMBAG]] — whose collaboration provisions between
Confederation, cantons and communes are plainly its subject matter — and its
predecessor *E-Government Schweiz* are all unestablished.

DVS publishes a blog post about the EMBAG, which is evidence it takes an
interest, not evidence of a role under the act. No edge is asserted.
