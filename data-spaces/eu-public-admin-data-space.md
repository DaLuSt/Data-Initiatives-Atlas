...
**None of those connections is asserted.** Every one would be plausible and
none is sourced, and this is exactly the entity where a repository would be
most tempted to draw them. The temptation is recorded instead:

- [ ] How does the public administration data space relate to
  [[EU-INTEROPERABLE-EUROPE-ACT]] and to [[EU-EIF]]?
- [ ] Does it build on [[EU-SDG]], the Single Digital Gateway?

Both are in `discovery/unresolved.md`.
