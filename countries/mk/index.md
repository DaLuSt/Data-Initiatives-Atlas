# North Macedonia — Index

Curated navigation hub for all North Macedonia-scoped (`country: MK`) entities in
the Atlas. This is a human-maintained page, not a generated one — add a
wikilink here whenever a new MK-scoped entity is judged important enough
to belong on the country's front page (`CONTRIBUTING.md`).

Anchor entity: [[MK]]

> **This country has no entities yet.** The anchor exists so that North Macedonia
