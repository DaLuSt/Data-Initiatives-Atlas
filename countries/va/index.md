...
Curated navigation hub for all Holy See-scoped (`country: VA`) entities in
the Atlas. This is a human-maintained page, not a generated one — add a
wikilink here whenever a new VA-scoped entity is judged important enough
to belong on the country's front page (`CONTRIBUTING.md`).

Anchor entity: [[VA]]

> **This country has no entities yet.** The anchor exists so that Holy See
