...
alternative_names:
  ...
  - Magyarország
description: >
  Country anchor entity for Hungary, a member state of the European Union
...
relationships:
  - type: part-of
    target: EU
    source: fact
    evidence: "Hungary is one of the 27 member states of the European Union, having acceded on 1 May 2004; the Union's own list of EU countries records its accession date together with its Schengen and euro status (european-union.europa.eu 'EU countries'). NOT READ — search-only. Anchor edge under metadata/relationship-types.md §2.3: it records EU membership and asserts no more than that."
    confidence: medium
    valid_from: null
    valid_until: null

sources:
  - title: "HU — Hungary (ISO 3166-1 country code)"
    url: "https://www.iso.org/obp/ui/#iso:code:3166:HU"
...
Hungary (ISO 3166-1 alpha-2: **`HU`**) is a **base country anchor**,
created so that entities scoped to it have somewhere to attach. No Hungary
...
| Council of Europe | Member since 1990 |
...
## Obliged to adopt the euro, and not doing so

Hungary is one of the five member states with **no euro opt-out
and no euro** — with [[SE]], [[PL]], [[CZ]] and [[RO]]. All five are legally
committed to adopting the single currency once they satisfy the convergence
criteria, and none has set a target date.

The distinction from [[DK]] is legal rather than practical: Denmark may
decline, the other five may only delay.
...
No EU instrument in the Atlas carries `applies-in` → [[HU]] yet.
