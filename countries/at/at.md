...
relationships:
  - type: part-of
    target: EU
    source: fact
    evidence: "Austria is one of the 27 member states of the European Union, having acceded on 1 January 1995; the Union's own list of EU countries records its accession date together with its Schengen and euro status (european-union.europa.eu 'EU countries'). NOT READ — search-only. Anchor edge under metadata/relationship-types.md §2.3: it records EU membership and asserts no more than that."
    confidence: medium
    valid_from: null
    valid_until: null
