...
Curated navigation hub for all Portugal-scoped (`country: PT`) entities in
the Atlas. This is a human-maintained page, not a generated one — add a
wikilink here whenever a new PT-scoped entity is judged important enough to
...
## What Portugal added to the Atlas

**A verb.** [[PT-LEI-58-2019]] *executes* the GDPR, where the Dutch act
implements it, the German supplements and concretises it, the Irish gives it
further effect and the British simply *is* it. All but two carry the same
relationship type; the varied language is how each legal tradition describes
