...
Curated navigation hub for all Georgia-scoped (`country: GE`) entities in
the Atlas. This is a human-maintained page, not a generated one — add a
wikilink here whenever a new GE-scoped entity is judged important enough
to belong on the country's front page (`CONTRIBUTING.md`).

Anchor entity: [[GE]]

> **This country has no entities yet.** The anchor exists so that Georgia
