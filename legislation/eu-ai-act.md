...
description: >
  ...
  in force from 1 August 2024 and applying in phases through 2028. It
  classifies AI systems by risk, prohibiting unacceptable-risk uses and
  imposing graduated obligations on high-risk and general-purpose AI.
...
relationships:
  - type: applies-in
    target: PT
    source: fact
    evidence: "As an EU regulation, Artificial Intelligence Act is binding in its entirety and directly applicable in all member states without national transposition, and Portugal is a member state (eur-lex.europa.eu; digital-strategy.ec.europa.eu). NOT READ — search-only."
    confidence: medium
    valid_from: null
    valid_until: null
  - type: applies-in
    target: LU
    source: fact
    evidence: "As an EU regulation, Artificial Intelligence Act is binding in its entirety and directly applicable in all member states without national transposition, and Luxembourg is a member state (eur-lex.europa.eu; digital-strategy.ec.europa.eu). NOT READ — search-only."
    confidence: medium
    valid_from: null
    valid_until: null
  - type: applies-in
    target: CZ
    source: fact
    evidence: "As an EU regulation, Artificial Intelligence Act is binding in its entirety and directly applicable in all member states without national transposition, and Czechia is a member state (eur-lex.europa.eu; digital-strategy.ec.europa.eu). NOT READ — search-only."
    confidence: medium
    valid_from: null
    valid_until: null
  - type: applies-in
    target: IE
    source: fact
    evidence: "As an EU regulation, Artificial Intelligence Act is binding in its entirety and directly applicable in all member states without national transposition, and Ireland is a member state (eur-lex.europa.eu; digital-strategy.ec.europa.eu; consilium.europa.eu). NOT READ — search-only."
    confidence: medium
    valid_from: null
    valid_until: null
  - type: applies-in
    target: NL
    source: fact
    evidence: "As an EU regulation the AI Act is directly applicable in all member states; it entered into force on 1 August 2024 with phased application (artificialintelligenceact.eu Article 113; EUR-Lex). NOT READ — search-only."
    confidence: medium
  ...
  - type: applies-in
    target: FR
    source: fact
    evidence: "As an EU regulation the AI Act is directly applicable in all member states, France included; it entered into force on 1 August 2024 with phased application (EUR-Lex). NOT READ — search-only."
    confidence: medium
    valid_from: 2024-08-01
    valid_until: null
  - type: applies-in
  ...
  - type: applies-in
    target: PL
    source: fact
    evidence: "As an EU regulation it is directly applicable in all member states, Poland included. NOT READ - search-only. No Polish AI supervisory authority was identified in this batch and none is asserted."
    confidence: medium
    valid_from: null
    valid_until: null
  - type: applies-in
...
Batch 8's brief warns against automatically classifying every digital
regulation as a data initiative. The AI Act qualifies on a specific basis
rather than by association: it regulates training data quality and
governance for high-risk systems, and the Digital Omnibus proposes a new
GDPR lawful basis specifically for processing personal data to develop AI
systems — placing it directly in the data-governance chain rather than
