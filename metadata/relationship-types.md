...
| `referred-to-cjeu-over` | A member state's national transposing instrument (subject) was referred by the European Commission to the Court of Justice of the EU, under TFEU Articles 258/260, for failure to transpose or fully notify transposition of the target EU directive/regulation. Distinct from `implements-requirement-from`, which records the transposition obligation itself, and from `applies-in`, which records mere applicability — this records a specific enforcement escalation, one procedural stage short of a judgment. Recorded on the national instrument rather than on [[EU-CJEU]], matching the phrasing "referred to the Court over [instrument]" this gap was originally flagged under on [[EU-OPEN-DATA-DIRECTIVE]] and [[EU-CJEU]]'s own entities. Where no national transposing instrument exists as an Atlas entity (e.g. Bulgaria and Latvia's Open Data Directive referral), the fact is recorded in the directive's own prose instead — a scoping gap, not a vocabulary one. Added 2026-09-20. First examples: [[IE-NCS-BILL]], [[ES-LCGC]], [[FR-NIS2-LOI]] and [[NL-CBW]] (all referred over [[EU-NIS2]] on 8 July 2026) and [[BE-HERGEBRUIK-WET-2023]] and [[NL-WHO]] (referred over [[EU-OPEN-DATA-DIRECTIVE]] on 15 February 2023). This does **not** close the separate, larger ontology gap of having no entity type for an individual infringement procedure (the stages before and after the referral, and any resulting judgment, remain unmodelled) |
