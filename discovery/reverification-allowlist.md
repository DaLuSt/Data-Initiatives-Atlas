...
**0 of the Atlas's 728 entities have never had a cited source read.** Their `sources:` URLs were confirmed to exist by a search index and nothing more, which is what `verification: search-only` records.
...
The Atlas currently cites **2559 source URLs** across **751 hosts**, collapsing to **540 registrable domains**.
