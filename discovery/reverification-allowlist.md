...
**0 of the Atlas's 729 entities have never had a cited source read.** Their `sources:` URLs were confirmed to exist by a search index and nothing more, which is what `verification: search-only` records.
...
The Atlas currently cites **2561 source URLs** across **753 hosts**, collapsing to **541 registrable domains**.
