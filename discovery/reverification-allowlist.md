...
**312 of the Atlas's 525 entities have never had a cited source read.** Their `sources:` URLs were confirmed to exist by a search index and nothing more, which is what `verification: search-only` records.
...
The Atlas currently cites **1764 source URLs** across **561 hosts**, collapsing to **406 registrable domains**.
