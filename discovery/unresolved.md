...
| **The 18 entities citing `gob.es`** — [[ES]], [[ES-AEAD]], [[ES-AESIA]], [[ES-CCN]], [[ES-CLAVE]], [[ES-CNI]], [[ES-DATOS-GOB-ES]], [[ES-ENS]], [[ES-ESPANA-DIGITAL-2026]], [[ES-LCGC]], [[ES-LEY-11-2002]], [[ES-LEY-37-2007]], [[ES-NTI-RISP]], [[ES-RDL-24-2021]], [[ES-RED-ES]], [[ES-SGAD]], [[INTL-IDS-RAM]], [[INTL-IDSA]] | Are their `gob.es` citations accurate? | **A human link check on 2026-08-20 found `gob.es` to be the one inaccurate domain** among the nineteen highest-value hosts — every other one resolved to what the Atlas claims. 33 URLs across 14 subdomains are affected. Three were provably wrong and are fixed: the `espanadigital.gob.es` citations on [[ES-NTI-RISP]], [[ES-AEAD]] and [[ES-AESIA]] were **plain `http://`**, the only government citations in the repository that were. Whether the remaining 30 are stale, moved or simply wrong **could not be narrowed from inside the session** — the egress proxy blocks `gob.es`. Treat every Spanish citation as suspect until checked individually | Manual link check / 2026-08-20 | **Open — the only domain a human has flagged** |
